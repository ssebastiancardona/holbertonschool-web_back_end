#!/usr/bin/env python3
"""
Paginación hipermedia resistente a eliminaciones
"""
...
class Server:
    """Clase de servidor para paginar
    una base de datos de nombres
    de bebés populares.
    """
    ...
    def indexed_dataset(self) -> Dict[int, List]:
        """Conjunto de datos indexado por posición
         de clasificación, comenzando en 0
        """
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        """
            Obtener el hiperíndice
            Argumentos:
                índice: página actual
